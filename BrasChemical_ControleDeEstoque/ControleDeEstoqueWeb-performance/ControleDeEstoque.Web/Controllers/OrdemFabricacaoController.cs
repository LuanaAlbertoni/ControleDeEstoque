...
namespace ControleDeEstoque.Web.Controllers
{
    ...
    {
        public ActionResult IndexVelho()
        {
        ...
        // GET: /OrdemFabricacao/
        public ActionResult Index(string LoteGerado)
        {
            if (!String.IsNullOrEmpty(LoteGerado)){
                ViewBag.LoteGerado = LoteGerado;
            }
        ...
        public ActionResult Create([Bind(Include = "LoteID,PreProdutoID,Data,Envasado,DataProducao")] OrdemFabricacao ordemfabricacao)
        {
            if (ModelState.IsValid)
            {
                ...
                return RedirectToAction("Index", new { LoteGerado = ordemfabricacao.LoteID });
            }
